...
let CronService = CronService_1 = class CronService {
    constructor(profileRepository, syncService, gamePlanEngine) {
    ...
    async calculateDailyGamePlans() {
        ...
        for (const profile of profiles) {
            try {
                ...
                const focusWeights = profile.focusWeights || { Career: 1.0, Love: 1.0, Money: 1.0 };
...
], CronService.prototype, "calculateDailyGamePlans", null);
exports.CronService = CronService = CronService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(profile_entity_1.UserProfile)),
