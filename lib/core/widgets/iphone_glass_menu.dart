              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    icon: const Icon(Icons.close_rounded, color: AppColors.textSecondaryDark, size: 22),
                  ),
                ],
              ),
              ...
              GridView.count(
                ...
                children: [
                  ...
                  _glassMenuItem(
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.push(context, MaterialPageRoute(builder: (_) => const PanchangScreen()));
                    },
                  ),
                  _glassMenuItem(
                    context,
                  ...
                  _glassMenuItem(
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.push(context, MaterialPageRoute(builder: (_) => const RemedyHubScreen()));
                    },
                  ),
                  _glassMenuItem(
                    context,
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.push(context, MaterialPageRoute(builder: (_) => const MuhuratScreen()));
                    },
                  ),
                  _glassMenuItem(
                    context,
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.push(context, MaterialPageRoute(builder: (_) => const AstrologySearchScreen()));
                    },
                  ),
                  _glassMenuItem(
                    context,
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.push(context, MaterialPageRoute(builder: (_) => const TrustCenterScreen()));
                    },
                  ),
                ],
              ),
